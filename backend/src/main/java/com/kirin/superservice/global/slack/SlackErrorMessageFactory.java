...
final class SlackErrorMessageFactory {
    ...
    static Map<String, Object> buildPayload(
            RuntimeException exception, ErrorRequestContext context, String activeProfile, String channel) {
    ...
    private static Map<String, Object> headerBlock(String activeProfile) {
        String profilePrefix = (activeProfile == null || activeProfile.isBlank()) ? "-" : activeProfile.toUpperCase();
        return Map.of(
                "type", "header",
                "text", Map.of(
                        "type", "plain_text",
                        "text", "[" + profilePrefix + "] 🚨 500 Internal Server Error 발생",
                        "emoji", true));
    }
    ...
    private static Map<String, Object> summaryBlock(
            RuntimeException exception, ErrorRequestContext context, String activeProfile) {
